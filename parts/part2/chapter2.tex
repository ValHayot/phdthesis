\chapter{Evaluation of pilot jobs for Apache Spark applications on HPC clusters}~\label{chp:spa}
...
\section{Abstract}
	...
	\begin{figure*}
		...
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/dedicated_1_beluga}
		\caption[]%
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/dedicated_2_beluga}
		\caption[]%
	...
	\begin{figure*}
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/dedicated_1_cedar}
		\caption[]%
		{{\small Configuration 1}}
		\label{fig:cedar1}
	    \end{subfigure}
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/dedicated_2_cedar}
		\caption[]%
		{{\small Configuration 2}}
		\label{fig:cedar2}
	    \end{subfigure}
    ...
    \begin{figure*}
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/nworkers_1_beluga}
		\caption[]%
		{{\small Configuration 1}}
		\label{fig:nwbeluga1}
	    \end{subfigure}
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/nworkers_2_beluga}
		\caption[]%
		{{\small Configuration 2}}
		\label{fig:nwbeluga2}
	    \end{subfigure}
	...
	\begin{figure*}
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/nworkers_1_cedar}
		\caption[]%
		{{\small Configuration 1}}
		\label{fig:nwcedar1}
	    \end{subfigure}
	    ...
	    \begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/part2-chp2/nworkers_2_cedar}
		\caption[]%
		{{\small Configuration 2}}
		\label{fig:nwcedar2}
	    \end{subfigure}
