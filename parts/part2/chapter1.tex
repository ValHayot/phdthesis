\chapter{Performance Evaluation of Big Data Processing Strategies for Neuroimaging}~\label{chp:bigdatastrategies}
...
\begin{algorithm2e}\caption{Incrementation}\label{alg:bigdata:incrementation}
\SetAlgoLined
...
Algorithm~\ref{alg:bigdata:incrementation}), (2) the task duration ($x$), (3) 
