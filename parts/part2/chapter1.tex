\chapter{CCGrid}~\label{chp:bigdatastrategies}
...
% \centering
%     \includegraphics[width=\textwidth]{figures/local-incrementation.pdf}
% \caption{Local Disk}
% \label{fig:modeleval-local}
%     \end{subfigure}%
% \begin{subfigure}{0.5\linewidth}
% \centering
%     \includegraphics[width=\textwidth]{figures/lustre-incrementation.pdf}
% \caption{Lustre}
