...
Manuscript in Preparation:\\
Val\'erie Hayot-Sasson, Mathieu Dugr\'e and Tristan Glatard. Sea: A lightweight data-management library for Big Data scientific
computing. 2022 \\
...
In this paper we introduce Sea, a user-space hierarchical data-management library for
...
applications without the need to entirely reinstrument the existing application.
...
\begin{itemize}
    \item Introduces a data-management library, Sea, for applications running on HPC
...
\subsection{File System implementations}
      ...
      XtreemFS uses the \gls{ldpreload} to intercept file system calls made to
...
\begin{figure*}
    ...
    \centering
    \includegraphics[scale=0.8]{figures/sea-comp/sea-flushevict.pdf}%
