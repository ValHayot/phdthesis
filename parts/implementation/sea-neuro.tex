\chapter{Automated neuroimaging data-management with Sea}\label{chapter:sea-neuro}
...
\section{Abstract}
  ...
  \section{Introduction}\label{sec:sea_neuro:introduction}
    ...
    Neuroimaging datasets continue to grow in size resulting in new data management challenges.
    ...
    I/O results in a non-negligible latency overhead. Addressing both of these
    ...
    %Big Data in neuroimaging can be present in two formats: 1)
    ...
    In this paper, we present Sea, a file system designed to automate data
    ...
    \resizebox{\textwidth}{!}{\begin{tabular}{|c c c c c|}
      \hline
      Dataset & Total Size (MB) & Total Number of images & Experiment parallel processes & Total compressed size processed (MB) \\
      \hline
      \multirow{3}{*}{PREVENT-AD} & \multirow{3}{*}{289,532} & \multirow{3}{*}{53,061} & 1 & 52\\
      & & & 8 & 402\\
      & & & 16 & 732\\
      \hline
      \multirow{3}{*}{ds001545} & \multirow{3}{*}{27,377} & \multirow{3}{*}{1,778} & 1 & 282\\
      & & & 8 & 2115\\
      & & & 16 & 4167\\
      \hline
      \multirow{3}{*}{HCP} & \multirow{3}{*}{83,140,079} & \multirow{3}{*}{15,716,060*} & 1 &  1301\\
      & & & 8 & 5998\\
      & & & 16 & 8328\\
    ...
    \begin{table*}[t]
      ...
      \hline
      \multirow{3}{1em}{FSL Feat} & PREVENT-AD & 254 & 191,148 & 28,099 & 1,338.29 \\
    ...
    For all experiments, we compared the performance of Sea with that of Lustre alone (baseline).
...
\end{figure*}
  ...
  Our results with flushing enabled confirm this theory. When running with flushling enabled,
  ...
  processing 1 HCP image. The maximum speedup for SPM was 3.2$\times$, processing 8 ds001545 images.
    ...
    Sea really shines when it is executed on a data-intensive pipeline. This
