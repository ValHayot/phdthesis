\chapter{Automated neuroimaging data-management with
...
\section{Abstract}
  ...
  \section{Introduction}\label{sec:sea_neuro:introduction}
    ...
    Sea is a data-management library that leverages the \texttt{LD\_PRELOAD}
    ...
    \begin{table*}[t]
      ...
      \hline
      Tool & Dataset &  Output Size (MB) & Total libc calls & Libc Lustre calls
      & Compute time (s)* \\
      \hline
...
\end{figure*}
  ...
  3.2$\times$, processing 8 ds001545 images.
    ...
    it is impossible for the average cluster user to know if Lustre's
