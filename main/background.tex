    ...
    \section{Current state of neuroimaging applications}
        ...
        \subsection{Big Neuroimaging Datasets}\label{datasets}
            ...
            as assessments (clinical and neuropsychometric) of 800 elderly
            ...
            CIVET~\cite{civet}, rather than creating their own. Therefore, there is a great
        ...
        \subsection{Infrastructure}\label{infrastructure} HPC infrastructure was
            ...
            The shared parallel file system is the slowest of all storage devices
            ...
            used within such infrastructure are distributed file systems, such as
    ...
    \section{Workflow composition}\label{workcomp}
        ...
        to acquire the skills to compose workflows without investing a
        ...
        \subsection{Workflow language}\label{lang} The choice of workflow
            ...
            and Scikit Learn~\cite{pedregosa2011scikit}, and a lower learning
            curve compared to other programming languages. Additionally, Python
            ...
            PSOM ensure compatibility with the GNU Octave programming language,
            ...
            default eliminating the need for users to install it manually. These
            features make workflow engine Make desirable for scientific
            ...
            \subsection{Data structures}\label{ds}
                ...
                abstractions addresses these issues by being a shared-memory
    ...
    \section{Performance}\label{performance} Neuroimaging frameworks are
        notoriously known to be compute-intensive. The workflows and their
        respective tools needed to incorporate parallelism in order to save on
        ...
        \subsection{Data-centric optimizations}\label{fs}
            ...
            on shared storage, making it generally more efficient than
            ...
            \subsubsection{Big Data file system optimizations for HPC}
                ...
                Writing Big Data to Lustre is very costly compared to local
                node storage. Distributed file systems found on HPC
        ...
        \subsection{Big Data Scheduling}\label{sched}
            ...
            node. In cluster mode, however, the driver is intended to be running
